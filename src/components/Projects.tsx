      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {profileConfig.projects.items.map((project, index) => (
            ...
            >
              {/* Project Image */}
              {project.useImage && project.image ? (
                <div className="h-48" style={{ backgroundColor: project.bgColor || '#f3f4f6' }}>
                  <img
                    src={project.image}
                ...
                <div className="h-48 flex items-center justify-center" style={{ backgroundColor: project.bgColor || '#3b82f6' }}>
